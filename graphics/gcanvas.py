...
class GCanvas(Frame):
    ...
    def __init__(self, root, window_width=320, window_height=240, canvas_width=10000, canvas_height=10000):
        ...
        # Initialize screen width and height, but will set them get_screen_size()
